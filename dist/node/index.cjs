...
_a = CrosswordClient;
CrosswordClient.initialize = async (options) => {
    var _b;
...
function wasm_crossword_generator_wasm(imports){return _loadWasmModule(0, '../wasm_crossword_generator_bg.wasm', null, imports)}

// @ts-ignore
setWasmInit(() => wasm_crossword_generator_wasm());

exports.CrosswordClient = CrosswordClient;
